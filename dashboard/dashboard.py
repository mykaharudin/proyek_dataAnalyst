...
with st.sidebar:
    ...
    with col1:
        st.write(' ')
    with col2:
        st.image('https://p1.hiclipart.com/preview/77/623/634/magnifying-glass-logo-data-analysis-big-data-analytics-data-science-business-intelligence-big-data-analytics-data-management-png-clipart.jpg')
    with col3:
        st.write(' ')
