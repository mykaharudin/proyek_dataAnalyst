...
with tab2:
    ...
    with st.expander("See Explanation"):
        st.write('Another piece of information is that there are more customers in cities that are capital cities (São Paulo, Porto Alegre, and the rest of Sekitart).')
